...
/**
 * 8. Implementar un algoritmo recursivo que permita calcular potencias de números reales
 * donde el exponente es un número entero, utilizando la propiedad: x^n = x . x^(n-1).
