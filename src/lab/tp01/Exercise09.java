...
/**
 * 9. Implementar un algoritmo recursivo que permita calcular potencias de números reales
 * donde el exponente es un número entero, utilizando la propiedad: x^(2n) = x^n . x^n.
 * ¿Cuál es el orden de complejidad temporal del algoritmo?
 *	Orden: {@code TOODO complejidad}.
 * @author Qcho
 */
public class Exercise09 {
    ...
    //TODO: consultar si me falta algo.
	...
	if (exp == 1) {
	    ...
	    double pow = pow_internal(n, exp/2);
	    return pow * pow;
	}
    }
}
